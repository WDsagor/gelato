...
const TopNavbar = () => {
  return (
    <div className="bg-black py-2">
      <div className="text-white text-center font-light flex flex-col sm:flex-row items-center gap-2 justify-center">
        ...
        <span className="group relative flex max-w-max flex-col items-center justify-center">
          <HiOutlineExclamationCircle
            ...
            size={22}
          />
          <div className="absolute group-hover:z-50 left-1/2 top-4 ml-auto mr-auto min-w-max -translate-x-1/2 hidden transform rounded-lg px-3 py-2  font-medium transition-all  group-hover:flex">
